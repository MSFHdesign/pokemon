...
function restartGame()
{
    ...
    setcookie('wildPokemons', '', time() - 3600);
}
            ...
            <div class="playerInfo">
                ...
                <div class="pokemon-ui">
                    ...
                    <div class="health-bar">
                        ...
                        ?>
                        <div class="health-progress <?php echo $healthClass; ?>" style="width: <?php echo $healthPercentage; ?>%;">
                            <p class="textCenter"> <?php echo $activePokemon->health; ?>/<?php echo $activePokemon->health; ?></p>
                        </div>
                    </div>
                    ...
                    <p class='names'>type: <?php echo is_array($activePokemon->type) ? implode(', ', $activePokemon->type) : $activePokemon->type; ?></p>
